...
function validation(form) {
    ...
    // let form = document.getElementById("engineForm  ");
    // console.log(form);
    ...
    if (flag == false) {
        ...
        alert(` ${form.name.value} will get a call from our agent for further details on ${transport_details.mobile}`)

        // form.cityName_input.value = ""
        // form.pickUp.value = ""
        // form.dropOff.value = ""
        // form.mob.value = ""
